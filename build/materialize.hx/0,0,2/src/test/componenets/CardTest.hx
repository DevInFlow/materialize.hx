...
class CardTest extends BaseTest {
    ...
    private function basicCard():Void {
        ...
        var cardTitle:CardTitle = new CardTitle({text:"model.Card Title"});
    ...
    private function revealCard():Void {
        ...
        var cardTitle:CardTitle = new CardTitle({text:'model.Card Title',classList:[activator, grayText, textDarken4]});
        var cardContent:CardContent = new CardContent({elements:[cardTitle], html:'<p><a href="#">This is a link</a></p>'});
        var cardReveal:CardReveal = new CardReveal({elements:[new CardTitle({text:'model.Card Title', classList:[grayText, textDarken4], elements:[new Icon({icon:Icons.CLOSE})]})],html:"<p>Here is some more information about this product that is only revealed once clicked on.</p>"});
    ...
    private function revealCardStickyAction():Void {
        ...
        var cardImage:CardImage = new CardImage({src:'https://materializecss.com/images/office.jpg'});
        var cardTitle:CardTitle = new CardTitle({text:'model.Card Title666'});


        var cardReveal:CardReveal = new CardReveal();
        var revealTitle:CardTitle = new CardTitle({text:'model.Card Title'});
